...
public class Worker : MonoBehaviour, IGoap
{
	...
	Inventory bakerInventory;
	public Inventory windmillInventory;

	void Start()
	{
		agent = this.GetComponent<NavMeshAgent>();
		bakerInventory = this.GetComponent<Inventory>();
	}
	...
	public HashSet<KeyValuePair<string,object>> GetWorldState () 
	{
		...
		worldData.Add(new KeyValuePair<string, object>("hasFlour", (bakerInventory.flourLevel > 1) ));
		worldData.Add(new KeyValuePair<string, object>("hasDelivery", (bakerInventory.breadLevel > 4) ));
